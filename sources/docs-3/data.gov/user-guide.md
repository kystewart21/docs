# Source: https://data.gov/user-guide

## Background [#](https://data.gov/user-guide/#background)
...
## Data Quality and Broken Links [#](https://data.gov/user-guide/#data-quality-and-broken-links)
...
## Data.gov Catalog Harvesting [#](https://data.gov/user-guide/#data-gov-catalog-harvesting)
...
## For Agency Data Publishers [#](https://data.gov/user-guide/#for-agency-data-publishers)
...
## Finding Datasets [#](https://data.gov/user-guide/#finding-datasets)

When you navigate to [https://catalog.data.gov/](https://catalog.data.gov/), you will see the first page of the entire catalog. By default, datasets are sorted first by relevance and then by popularity, based on OpenSearch scores and page views from the past month. These numbers are displayed at the bottom of each dataset card.

![Data.gov catalog landing page](https://data.gov/_img/dg-user-guide_dataset-listing.png)

To choose a different ordering, such as by Popularity, use the Sort by dropdown menu in the upper right corner of the page.

![Data.gov catalog sort by](https://data.gov/_img/dg-user-guide_sort.png)
...
![Data.gov catalog search tips](https://data.gov/_img/dg-user-guide_search-tips.png)
...
![Data.gov catalog search filters](https://data.gov/_img/dg-user-guide_search-filter.png)

You can also search for datasets by Geography, such as a zip code.

![Data.gov catalog seach by location](https://data.gov/_img/dg-user-guide_search-geography.png)
...
![Data.gov catalog search by organization](https://data.gov/_img/dg-user-guide_search-by-org.png)

## Understanding Dataset Pages [#](https://data.gov/user-guide/#understanding-dataset-pages)
...
![Data.gov catalog Complete Metadata](https://data.gov/_img/dg-user-guide_metadata.png)
...
![Data.gov catalog dataset Resources](https://data.gov/_img/dg-user-guide_resources.png)
...
![Data.gov catalog dataset sidebar info](https://data.gov/_img/dg-user-guide_dataset-sidebar.png)

## Geospatial Datasets [#](https://data.gov/user-guide/#geospatial-datasets)
...
## Data.gov catalog API [#](https://data.gov/user-guide/#data-gov-catalog-api)
...
## Contact Data.gov [#](https://data.gov/user-guide/#contact-data-gov)
